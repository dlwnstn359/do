...
st.header("조선 시대")
st.write("조선왕조실록에는 울릉도와 독도에 대한 기록이 많이 나타난다. 『태종실록』 기록에 1416년 박습이 태종에게 보고한 내용 중 울릉도 곁에 소도가 있다고 하였다.
또 『세종실록』 지리지 울진현 편에는 우산과 무릉 2섬이 현의 정동쪽 바다 가운데 있고 2섬이 서로 거리가 멀지 아니하여, 날씨가 맑으면 가히 바라볼 수 있다고 하였다.")
st.header("플러스")
st.write("1905년 일본이 러일전쟁 중에 내각 결의를 통하여 독도를 일본 영토에 편입시키고 그들의 땅이라고 주장했다. 1906년 울도군수 심흥택이 울도군 소속 독도에 일본인이 와서 조사하고 갔다는 보고서를 올리자 조선 정부에서 지령을 내려 “독도가 일본 영토라는 설은 전혀 근거가 없는 것”이라며, “독도의 형편과 일본인들의 행동을 다시 조사하여 보고하라”고 하였다.
